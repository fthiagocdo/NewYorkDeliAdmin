...
<div class="container container-content">
	<div class="row">
		<h3 class="center-align hide-on-small-only">Add Menu Type</h3>
	    <h5 class="center-align hide-on-med-and-up">Add Menu Type</h3>
		<div class="divider"></div>
	</div>
	<div class="row"></div>	
	<div class="row">
		<form action="{{ route('admin.menutype.save') }}" method="post">
