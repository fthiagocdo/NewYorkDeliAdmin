...
<div class="container container-content">
	<div class="row">
		<h3 class="center-align hide-on-small-only">Edit Menu Type</h3>
	    <h5 class="center-align hide-on-med-and-up">Edit Menu Type</h3>
		<div class="divider"></div>
	</div>
	<div class="row"></div>
	<div class="row">
		<form action="{{ route('admin.menutype.update', Session::get('register')->id) }}" method="post">
			
			{{ csrf_field() }}

			<input type="hidden" name="_method" value="put">

			@include('admin.menutype._form')
