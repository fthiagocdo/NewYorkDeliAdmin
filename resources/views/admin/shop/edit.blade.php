...
<div class="container container-content">
	<div class="row">
		<h3 class="center-align hide-on-small-only">Edit Shop</h3>
	    <h5 class="center-align hide-on-med-and-up">Edit Shop</h3>
		<div class="divider"></div>
	</div>
	<div class="row"></div>
	<div class="row">
		<form action="{{ route('admin.shop.update', Session::get('register')->id) }}" method="post">
