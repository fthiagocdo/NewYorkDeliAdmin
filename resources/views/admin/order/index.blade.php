...
<div class="container container-content">
    <div class="row">
        <h3 class="center-align hide-on-small-only">List of Orders</h3>
        <h5 class="center-align hide-on-med-and-up">List of Orders</h3>
        ...
        <table class="table striped">
            ...
            @foreach($registers as $register)
                <tr>
                    ...
                    <td>{{ ucwords($register->user->name) }}</register>
